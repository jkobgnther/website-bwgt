...
export default function ContactBanner() {
  return (
    <section className="section bg-[#7FBF97] text-white">
      <div className="container-custom">
        <div className="max-w-3xl mx-auto">
          <h2 className="heading-2 text-white text-center mb-8">Kontakt</h2>
          ...
          <div className="text-center">
            <Link href="/kontakt" className="btn bg-[#EEEA63] text-gray-900 hover:bg-[#d4d059] shadow-md">
